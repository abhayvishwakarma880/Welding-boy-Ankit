      ...
      <div className="rounded-3xl bg-gradient-to-r from-black via-[#111111] to-black border border-brand/20 p-6 md:p-10 lg:p-12 shadow-2xl">
        <div className="space-y-6 text-white leading-8 text-[15px] md:text-lg">
          <p>
            ...
            services with a strong focus on durability, precision, and clean
            finishing. We specialize in creating metal structures that are built
            to perform under daily use while maintaining strength and long-term
            reliability.
          </p>
          ...
          <p>
            ...
            and custom metal structures with attention to every measurement and
            finish.
          </p>
